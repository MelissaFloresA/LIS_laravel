...
<body>
    ...
    <div class="container py-4">
        ...
        <ul class="nav nav-tabs mb-4" id="cuponesTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="vencidos-tab" data-bs-toggle="tab" data-bs-target="#vencidos"
                    type="button" role="tab">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card coupon-card position-relative overflow-hidden border-0  rounded-4">
                                    <div class="row g-0 h-100">
                                        ...
                                        <div class="col-md-8">
                                            <div
                                                class="card-body d-flex flex-column justify-content-between h-100 text-white">
                                                <div>
